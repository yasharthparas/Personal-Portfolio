          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/yasharth-sharma"><img src={linkedin} alt="linkedin" /></a>
                <a href="https://www.facebook.com/yasharthparas.sharma"><img src={facebook} alt="facebook" /></a>
                <a href="https://www.instagram.com/shre_yash_1202"><img src={instagram} alt="instagram" /></a>
                <a href="https://github.com/yasharthparas"><img src={github} alt="github" /></a>
              </div>
            </span>
          </Navbar.Collapse>
        </Container>
